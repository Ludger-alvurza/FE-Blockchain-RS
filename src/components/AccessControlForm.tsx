...
export default function AccessControlForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast("Access control berhasil dibuat", "success");
      setSuccess(true);
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-800 p-6 max-w-3xl">
      <h2 className="text-lg font-semibold mb-6">Buat Access Control Baru</h2>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          />
          <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
            ID user (dokter/staff) yang akan diberi akses
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
            ID admin yang memberikan/mengotorisasi akses
          </p>
        </div>
